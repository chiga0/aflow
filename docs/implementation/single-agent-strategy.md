...
> 结论：先直接部署 Qwen Code 实例作为 worker，并在外层构建云端 runtime；不要一开始深 fork，也不要从头实现完整 coding agent。等任务、权限、事件、沙箱和恢复需求稳定后，再小范围 fork 或抽取核心模块。
...
- `/Users/gawain/Documents/codebase/opensource/qwen-code/docs/users/qwen-serve.md`
- `/Users/gawain/Documents/codebase/opensource/qwen-code/docs/developers/qwen-serve-protocol.md`
- `/Users/gawain/Documents/codebase/opensource/qwen-code/packages/core/src/agents/runtime/agent-core.ts`
- `/Users/gawain/Documents/codebase/opensource/qwen-code/packages/core/src/agents/runtime/agent-events.ts`
...
- `/Users/gawain/Documents/codebase/opensource/qwen-code/packages/core/src/core/coreToolScheduler.ts`
- `/Users/gawain/Documents/codebase/opensource/qwen-code/packages/core/src/permissions/permission-manager.ts`
...
- `/Users/gawain/Documents/codebase/opensource/claude-code/docs/architecture.md`
- `/Users/gawain/Documents/codebase/opensource/claude-code/docs/agent-orchestration-analysis.md`
...
- `/Users/gawain/Documents/codebase/opensource/gemini-cli/docs/core/subagents.md`
- `/Users/gawain/Documents/codebase/opensource/gemini-cli/docs/core/remote-agents.md`
- `/Users/gawain/Documents/codebase/opensource/gemini-cli/docs/cli/checkpointing.md`
...
- `/Users/gawain/Documents/codebase/github/opencode/packages/opencode/src/agent/agent.ts`
...
本阶段尽量不改 Qwen Code 源码。

### 阶段 2：协议 adapter

写一层 adapter，把 qwen-code 的事件转成内部 canonical events：

```text
qwen event/jsonl -> adapter -> run_events
```

好处：

- 将来可以替换为 Claude Code、OpenCode、Gemini CLI 或自研 worker。
...
外层 Run Manager 不应依赖 Qwen Code 内部类型，只依赖 worker 契约：
...
- worker 可以是 Qwen Code，也可以是其他 agent。
