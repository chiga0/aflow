...
Produces web/e2e/screenshots/{mobile,desktop}-{1..5}-*.png covering:
...
from runtime.tests.fake_pi import make_fake_pi  # noqa: E402
...
def main() -> int:
    ...
    if not static_dir.is_dir():
        print("web/dist missing — run `npm run build` in web/ first", file=sys.stderr)
        return 2
